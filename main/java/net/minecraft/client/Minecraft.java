...
import cc.sleek.client.event.impl.MouseEvent;
import cc.sleek.client.module.impl.ghost.NoHitDelay;
import cc.sleek.client.util.Delta;
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    case MISS:
                    default:
                        if (this.playerController.isNotCreative() && !Sleek.INSTANCE.getModuleManager().getModuleByClass(NoHitDelay.class).isToggled()) {
                            this.leftClickCounter = 10;
                        }
                }
            }
...
//        Sleek.INSTANCE.getEventBus().post(new TickEvent());
        // commented out to bc deprecated
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    Sleek.INSTANCE.getEventBus().post(new MouseEvent(i));
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    Sleek.INSTANCE.getEventBus().post(keyboardEvent);
