...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null) {
            KillAura aura = (KillAura) Sleek.INSTANCE.getModuleManager().getModuleByName("KillAura");
            boolean fakeAB = aura.isShouldBlock();
            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (enumaction) {
                    ...
                    case BLOCK:
                        RenderItemEvent event = new RenderItemEvent(f1, f, f2, f3);
                        Sleek.INSTANCE.getEventBus().post(event);
                        if (!event.isOverriding()) {
                            this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                        }
                        break;
