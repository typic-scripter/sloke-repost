...
import cc.sleek.client.module.impl.ghost.Reach;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            Reach reach = Sleek.INSTANCE.getModuleManager().getModuleByClass(Reach.class);
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (reach.isToggled() ? reach.getReach().getValue() : 3.0D)) { // THE FUNNY
            ...
            if (this.pointedEntity != null && (d2 < (reach.isToggled() ? reach.getReach().getValue() : d1) || this.mc.objectMouseOver == null)) {
