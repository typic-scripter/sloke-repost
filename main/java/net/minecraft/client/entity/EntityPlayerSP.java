...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            UpdateEvent event = new UpdateEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            Sleek.INSTANCE.getEventBus().post(event);
            ...
            Sleek.INSTANCE.getEventBus().post(new UpdateEvent(false));
        }
    }
    ...
    public void moveEntity(double motionX, double motionY, double motionZ) {
        MoveEvent event = new MoveEvent(motionX, motionY, motionZ);
        Sleek.INSTANCE.getEventBus().post(event);
    ...
    public boolean isMovingOnGround() {
        return mc.thePlayer.onGround && mc.thePlayer.isMoving();
    }
}
