    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder p_147202_3_)
    {
        ...
        if (list != null && list.size() >= 3)
        {
            for (int i = 1; i < list.size(); ++i)
            {
                ...
                p_147202_3_.append(profiler$result.usePercentage).append(" - ").append(String.format("%.2f", profiler$result.totalUsePercentage)).append("%/").append(String.format("%.2f", profiler$result.totalUsePercentage)).append("%\n");
